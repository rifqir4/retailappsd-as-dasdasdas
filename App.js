...
import PelangganSuccess from "./app/screens/PelangganSuccess";
    ...
    return (
      <NavigationContainer>
        <Stack.Navigator>
          ...
          <Stack.Screen
            name="InputBarangSuccess"
            component={InputBarangSuccess}
            options={{ title: "Success" }}
          />
          <Stack.Screen
            name="PelangganSuccess"
            component={PelangganSuccess}
            options={{ title: "Success" }}
          />
        </Stack.Navigator>
